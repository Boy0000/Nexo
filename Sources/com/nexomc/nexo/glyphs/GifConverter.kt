...
object GifConverter {
    ...
    fun splitGif(gif: Texture, frameCount: Int): Texture {
        val decoder = GifDecoder()
        decoder.read(gif.data())
    ...
    private fun createSpritesheet(frames: List<BufferedImage>, gif: Texture): Texture {
        ...
        }.printOnFailure().getOrDefault(byteArrayOf())

        val spriteSheet = Texture.texture(gif.key().replace(".gif", ".png"), Writable.bytes(data))
